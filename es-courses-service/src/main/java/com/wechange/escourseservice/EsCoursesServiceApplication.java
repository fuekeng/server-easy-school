package com.wechange.escourseservice;
...
@SpringBootApplication(scanBasePackages = { "com.wechange.easyschool", "com.wechange.easyschool.escommon.repository",
		"com.wechange.easyschool.escommon", "com.wechange.escourseservice" })
@EnableConfigurationProperties
@EnableEurekaClient
@EnableMongoRepositories(basePackages = { "com.wechange.easyschool.escommon.repository",
		"com.wechange.escourseservice.repository" })
...
@EnableSwagger2
public class EsCoursesServiceApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(EsCoursesServiceApplication.class, args);
	}
